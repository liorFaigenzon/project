namespace Exercise.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            CreateTable(
                "dbo.QueueNodeViewModels",
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        QueueNumber = c.String(),
                        Status = c.String(),
                        TimeStamp = c.DateTime(nullable: false),
                        CustomerId_Id = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CustomerViewModels", t => t.CustomerId_Id)
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.QueueNodeViewModels");
        }
    }
}
